...
from db.teachers import add_course_teacher, add_teacher, delete_teacher, get_teacher, get_teacher_courses, get_teachers, update_teacher
    ...
    try:
        async with db.pool.acquire() as conn:
            ...
            for course in teacher.courses:
                print(course)
                print(teacher_id['insert_teacher'])
